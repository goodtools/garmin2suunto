...
public class GActivity {
    ...
    private GActivity.Value activityName;
    @SerializedName("activityDescription")
    private GActivity.Value activityDescription;
    @SerializedName("locationName")
    private GActivity.Value locationName;
    @SerializedName("isElevationCorrected")
    private boolean elevationCorrected;
    @SerializedName("isBarometricCapable")
    private boolean barometricCapable;
    @SerializedName("isSwimAlgorithmCapable")
    private boolean swimAlgorithmCapable;
    @SerializedName("isActivityEdited")
    private boolean activityEdited;
    @SerializedName("favorite")
    private boolean favorite;
    @SerializedName("activityType")
    private GFieldSet activityType;
    @SerializedName("eventType")
    private GFieldSet eventType;
    @SerializedName("activityTimeZone")
    private GFieldSet activityTimeZone;
    @SerializedName("totalLaps")
    private GActivity.TotalLaps totalLaps;
    ...
    public void setActivityId(String var1) {
        this.activity.activityId = var1;
    }

    public String getActivityName() {
        return this.activity.activityName.value;
    }

    public void setActivityName(String var1) {
        this.activity.activityName.value = var1;
    }

    public String getActivityDescription() {
        return this.activity.activityDescription.value;
    }

    public void setActivityDescription(String var1) {
        this.activity.activityDescription.value = var1;
    }

    public String getLocationName() {
        return this.activity.locationName.value;
    }

    public void setLocationName(String var1) {
        this.activity.locationName.value = var1;
    }

    public boolean isElevationCorrected() {
        return this.activity.elevationCorrected;
    }

    public void setElevationCorrected(boolean var1) {
        this.activity.elevationCorrected = var1;
    }

    public boolean isBarometricCapable() {
        return this.activity.barometricCapable;
    }

    public void setBarometricCapable(boolean var1) {
        this.activity.barometricCapable = var1;
    }

    public boolean isSwimAlgorithmCapable() {
        return this.activity.swimAlgorithmCapable;
    }

    public void setSwimAlgorithmCapable(boolean var1) {
        this.activity.swimAlgorithmCapable = var1;
    }

    public boolean isActivityEdited() {
        return this.activity.activityEdited;
    }

    public void setActivityEdited(boolean var1) {
        this.activity.activityEdited = var1;
    }

    public boolean isFavorite() {
        return this.activity.favorite;
    }

    public void setFavorite(boolean var1) {
        this.activity.favorite = var1;
    }
    ...
    public void setActivityType(GFieldSet var1) {
        this.activity.activityType = var1;
    }

    public GFieldSet getEventType() {
        return this.activity.eventType;
    }

    public void setEventType(GFieldSet var1) {
        this.activity.eventType = var1;
    }

    public GFieldSet getActivityTimeZone() {
        return this.activity.activityTimeZone;
    }

    public void setActivityTimeZone(GFieldSet var1) {
        this.activity.activityTimeZone = var1;
    }
    ...
    public GActivity.TotalLaps getTotalLaps() {
        return this.activity.totalLaps;
    }

    public void setTotalLaps(GActivity.TotalLaps var1) {
        this.activity.totalLaps = var1;
    }

    public String toString() {
        return "Activity: " + this.getActivityId() + " " + this.getActivityName();
    }
    ...
    public class TotalLaps {
        @SerializedName("lapSummaryList")
        ArrayList<GSummary> lapSummaryList;

        public TotalLaps() {
        }

        public ArrayList<GSummary> getLapSummaryList() {
            return this.lapSummaryList;
        }

        public void setLapSummaryList(ArrayList<GSummary> var1) {
            this.lapSummaryList = var1;
        }
    }
}
